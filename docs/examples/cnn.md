...
| Layer | Accuracy | Meaning |
|-------|----------|---------|
| `conv1` | 82.9% | Visual features, some class info |
| `conv2` | 78.1% | More abstract features |
| `fc1` | 96.7% | **Class information fully encoded** |
| `fc2` | 83.0% | Logits, less informative for probing |
