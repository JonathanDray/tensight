...
!!! info "Research Background"
    Based on: ["Visualizing the Loss Landscape of Neural Nets"](https://arxiv.org/abs/1712.09913) (Li et al., NeurIPS 2018)
...
!!! important "Always use filter normalization"
    Filter normalization (Li et al., 2018) ensures fair comparison across layers with different weight scales. 
    **Always use `use_filter_norm=True`** for meaningful results.
